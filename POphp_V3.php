...
<html>
    <head>
        ...
        <style>
            ...
            .image__image_page::-webkit-scrollbar-thumb {
    ...
    <body>
        ...
        <div class="profile_settings_page hidden">
            ...
            <div class="profile_pfp_space">
                ...
                <p class="cbx_txt" id="pfp_txt" style="cursor:pointer;">profile picture here</p>
            </div>
            <div class="profile_folder_space">
                <p class="cbx_txt">Folders: </p>
                <p class="cbx_txt" id="folders_txt" style="">List of folders here</p>
            </div>
            <div class="profile_paginas_space">
                <p class="cbx_txt">Paginas: </p>
                <p class="cbx_txt" id="paginas_txt" style="">List of pages here</p>
            </div>
        </div>
        <div class="navbar">
            ...
            <button class="new_btn" style="left: 15%;">
                <p style="position:absolute;top:7.5%;left:0;width:100%;height:100%;">random</p>
            </button>
            <input placeholder="Search for articles, folders, images, or users" class="searchbar" name="text" type="text">
            ...
            if ($paginadata && $paginadata->num_rows > 0) {
                while ($row = $paginadata->fetch_assoc()) {
                    $paginas[] = [
                        ...
                        'inhoud' => htmlspecialchars($row['Inhoud']),
                        'afbeelding_posities' => htmlspecialchars($row['afbeeldingen_posities']),
        ...
        <script>
            ...
            for(let x = 0; x<all_images_src.length; x++){
                ...
                img.addEventListener("mouseover", (e)=>{
                    document.getElementById(`text_${img.id}`).style.top = e.pageY + "px";
                    document.getElementById(`text_${img.id}`).style.left = e.pageX + "px";
                    document.getElementById(`text_${img.id}`).classList.remove("hidden");
                });
                img.addEventListener("mouseout", ()=>{
                    document.getElementById(`text_${img.id}`).classList.add("hidden");
                });
            ...
            document.getElementById("pfp_txt").addEventListener("click", ()=>{
                if(!(username == "guest")){
                    ...
                    console.log(moderator_application);
